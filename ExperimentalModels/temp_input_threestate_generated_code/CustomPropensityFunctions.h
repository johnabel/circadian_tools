...
double f15(_populationVectorType& x) {
    return (double)std::max(0.0,(41.5+100*(0+x[0])*1.0-x[0]))*pow(50,4)/(double)(pow(50,4)+pow(x[2],4));
}

template<typename _populationVectorType>
double f16(_populationVectorType& x) {
    return (double)std::max(0.0,(41.5+100*(0+x[0]+x[3])*0.5-x[3]))*pow(50,4)/(double)(pow(50,4)+pow(x[5],4));
}

template<typename _populationVectorType>
double f17(_populationVectorType& x) {
    return (double)std::max(0.0,(41.5+100*(0+x[3]+x[6])*0.5-x[6]))*pow(50,4)/(double)(pow(50,4)+pow(x[8],4));
}
