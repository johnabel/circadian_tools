...
param=[  2.25159896e-01*af2,   1.90031674e-01,   6.70692205e-02,
         2.63970881e-01,   1.55918619e-01,   2.59850992e-01,
         7.81672489e-01,   1.23769111e+00,   7.95480246e-03*af2,
         ...
         2.67511407e-01,   2.06409164e-03,   4.07754219e+00*1/af2,
         1.27824043e-01*af2,   2.96422108e-01,   9.31597225e-02,
...
def main():
    ...
    StochPopEval.PlotPopPartial('p',period,Desc='SCN Network, 225 Cells', tstart=0,color='black',traces=False)
    StochPopEval.PlotPopPartial('c1',period,Desc='SCN Network, 225 Cells', tstart=0,color='blue',traces=False)
    StochPopEval.PlotPopPartial('c2',period,Desc='SCN Network, 225 Cells', tstart=0,color='red',traces=False)
