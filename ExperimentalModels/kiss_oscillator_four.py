...
y0in = [-1.29374616,  0.67413515, -1.62914683,  0.87060893, 
        -1.62914683,  0.87060893, -1.62914683,  0.87060893]
period = 13.92
...
def kiss_model_ode():
    ...
    state_set = cs.vertcat([e1, tht1, e2, tht2, e3, tht3, e4, tht4])
    ...
    # oscillator 2
    ode[2] = (V+100*np.sin(10*t)-e2)/A2Rind2 - \
...
if __name__ == "__main__":
    ...
    plt.plot(kiss_odes.ts,kiss_odes.sol[:,2],label = 'e2, V oscillatory')
